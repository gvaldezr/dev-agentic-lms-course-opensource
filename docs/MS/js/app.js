// ============================================================
// Mini Sitio — Medios Sociales · UADY
// SPA con hash routing + progreso + whimsy (Ruta del Jaguar Social)
// ============================================================
import { ASSETS } from './assets.js';
import { CONTENT, CONTENT_STYLES } from './content.js';
import { LECTURAS } from './lecturas.js';

// ---- Metadatos de las 5 ADAs (de outline_curso.json + narrativa Medios Sociales) ----
const ADAS = [
  { n: 1, acto: 'I · Explorar',    emoji: '🌐', titulo: 'Fundamentos de los Medios Sociales',
    producto: 'Radiografía del Ecosistema Digital',
    corto: 'Ecosistema Digital', bloom: 'Comprender / Aplicar', sesiones: 'Sesiones 1–6', nSes: 6,
    bridge: 'Ya conoces el ecosistema. Ahora aprende a trazar una estrategia con intención.' },
  { n: 2, acto: 'II · Planear',    emoji: '🧭', titulo: 'Estrategia y Planificación de Contenido',
    producto: 'Brief Estratégico de Comunicación Digital',
    corto: 'Brief Estratégico', bloom: 'Aplicar / Analizar', sesiones: 'Sesiones 7–12', nSes: 6,
    bridge: 'Tienes un plan. Es hora de crear el contenido que le dará vida.' },
  { n: 3, acto: 'III · Crear',     emoji: '🎬', titulo: 'Creación de Contenido Multimedia',
    producto: 'Portafolio de Contenido Multimedia',
    corto: 'Portafolio Multimedia', bloom: 'Analizar / Evaluar', sesiones: 'Sesiones 13–18', nSes: 6,
    bridge: 'Sabes crear. Ahora piensa críticamente sobre el impacto de lo que publicas.' },
  { n: 4, acto: 'IV · Reflexionar', emoji: '⚖️', titulo: 'Ética y Pensamiento Crítico en Redes',
    producto: 'Protocolo de Ciudadanía Digital Responsable',
    corto: 'Ciudadanía Digital', bloom: 'Evaluar / Crear', sesiones: 'Sesiones 19–23', nSes: 5,
    bridge: 'Tienes criterio ético. Úsalo para transformar tu comunidad con una causa real.' },
  { n: 5, acto: 'V · Transformar', emoji: '🚀', titulo: 'Aplicación en Problemáticas Sociales',
    producto: 'Campaña Social Digital Integral',
    corto: 'Campaña Social', bloom: 'Crear / Sintetizar', sesiones: 'Sesiones 24–28', nSes: 5,
    bridge: 'Has completado la Ruta del Jaguar Social. Ahora eres estratega de medios sociales.' },
];
const COMPETENCIA = 'Desarrollar una propuesta de administración de medios sociales en diferentes ámbitos de la vida cotidiana mediante el uso de las tecnologías de la información con postura ética y responsabilidad digital.';

// Metadatos de presentaciones ("El Mirador") por ADA
const PRES = {
  1: { slides: 13, mins: 15, title: 'Fundamentos de los Medios Sociales', intro: 'Antes de recorrer el sendero, sube al mirador. Observarás todo el paisaje de los medios sociales en 2026 — plataformas, algoritmos, formatos e impacto sociocultural.', topics: ['Ecosistema','Algoritmos','Formatos','Impacto social'] },
  2: { slides: 13, mins: 15, title: 'Estrategia y Planificación de Contenido', intro: 'Desde este punto alto verás cómo se diseña una estrategia digital — objetivos SMART, KPIs, buyer personas, embudo de conversión y calendario editorial.', topics: ['Objetivos SMART','KPIs','Buyer Persona','Embudo'] },
  3: { slides: 13, mins: 15, title: 'Creación de Contenido Multimedia', intro: 'La vista desde aquí es pura creación. Diseño, video, IA generativa, UGC y social commerce — el arsenal creativo del estratega de medios sociales.', topics: ['Canva/CapCut','IA generativa','UGC','Social commerce'] },
  4: { slides: 13, mins: 15, title: 'Ética y Pensamiento Crítico en Redes', intro: 'Desde este mirador se ve el terreno de la responsabilidad digital — desinformación, deepfakes, privacidad (LFPDPPP), accesibilidad y gestión de crisis.', topics: ['Desinformación','Deepfakes','LFPDPPP','Accesibilidad'] },
  5: { slides: 13, mins: 15, title: 'Aplicación en Problemáticas Sociales', intro: 'El mirador más alto de la Ruta. Aquí se ven las campañas que cambian realidades — storytelling con datos, engagement, marca personal y creator economy.', topics: ['Storytelling','Engagement','Marca personal','Dashboard'] },
};
// Introducción narrativa del "Sendero de inscripciones" por ADA
const SENDERO_INTRO = {
  1: 'Las primeras estelas del sendero te muestran el mapa completo: plataformas, algoritmos, formatos y el impacto social de las redes. Descífralas para empezar a explorar.',
  2: 'Estas estelas te enseñan a planear con estrategia — del "me gusta" al objetivo, del público al buyer persona, del contenido al calendario editorial.',
  3: 'Aquí las inscripciones no solo informan — crean. Estelas sobre diseño, video, IA generativa y contenido que conecta con audiencias reales.',
  4: 'Las estelas de este sendero exigen criterio. Desinformación, deepfakes, privacidad y accesibilidad: la ética que todo estratega digital debe descifrar.',
  5: 'Las últimas estelas son las más poderosas. Aquí se inscribe el lenguaje de las campañas que transforman: datos, storytelling, engagement y creator economy.',
};
...
const STORAGE_KEY = 'ms_progress_v1';
...
function renderHome() {
  ...
  <div class="view-enter">
    <section class="hero" aria-labelledby="hero-title">
      ...
      <div class="hero__container">
        <div class="hero__content">
          <p class="hero__tagline scroll-reveal">De usuario a estratega. Tu camino en los medios sociales comienza aquí.</p>
          <div class="hero__badges scroll-reveal" style="--i:1">
            <span class="badge badge--outline">5° Semestre</span>
            <span class="badge badge--outline">28 sesiones</span>
            <span class="badge badge--outline">5 ADAs</span>
          </div>
          <h1 class="hero__title scroll-reveal" style="--i:2" id="hero-title">Medios Sociales</h1>
        ...
        <div class="hero__visual" aria-hidden="true">
          <div class="bloom-spiral">
            <div class="bloom-node" data-level="1">🌐 Explorar</div>
            <div class="bloom-node" data-level="2">🧭 Planear</div>
            <div class="bloom-node" data-level="3">🎬 Crear</div>
            <div class="bloom-node" data-level="4">⚖️ Reflexionar</div>
            <div class="bloom-node" data-level="5">🚀 Transformar</div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section" aria-labelledby="ruta-title">
      ...
      <nav class="journey-map scroll-reveal" aria-label="Mapa de la ruta del jaguar social">${nodes}</nav>
    </section>
    ...
    <section class="section section--alt" aria-labelledby="logros-title">
      <div class="container">
        ...
        <p class="section__subtitle scroll-reveal">Al final del recorrido tendrás un portafolio real de medios sociales.</p>
        <div class="value-grid">
          <div class="value-card scroll-reveal"><div class="value-card__icon" aria-hidden="true">📱</div><h3>Portafolio real</h3><p>5 piezas profesionales listas para mostrar: ecosistema, brief, portafolio, protocolo y campaña.</p></div>
          <div class="value-card scroll-reveal" style="--i:1"><div class="value-card__icon" aria-hidden="true">🧠</div><h3>Skills 2026</h3><p>Estrategia, IA generativa, ética digital y analítica que el mundo digital pide hoy.</p></div>
          <div class="value-card scroll-reveal" style="--i:2"><div class="value-card__icon" aria-hidden="true">🌎</div><h3>Impacto local</h3><p>Aplicas cada aprendizaje a Mérida, Yucatán y a causas que te importan.</p></div>
        </div>
      </div>
    </section>
...
function renderAda(n) {
  ...
  const contentStyle = CONTENT_STYLES && CONTENT_STYLES[String(n)] ? `<style>${CONTENT_STYLES[String(n)]}</style>` : '';
  ...
  <article class="view-enter ada-view" data-ada="${n}">
    ...
    <p class="ada-bridge">"${esc(a.bridge)}" <span class="jag-term" title="Jag, tu estratega guía">— Jag 🐆</span></p>
  ...
  <div class="view-enter">
    <section class="completion" aria-labelledby="complete-title">
      ...
      <div class="completion__inner">
        ...
        <p class="completion__subtitle">Ahora eres estratega de medios sociales.</p>
        ...
        <p class="completion__quote">"Los medios sociales no se dominan improvisando. Se dominan con estrategia, creatividad, ética y datos."</p>
...
function renderSidebar() {
  ...
  <nav class="progress-tracker" aria-label="Progreso del curso">
    <div class="progress-tracker__header">
      <h4 class="progress-tracker__title">Ruta del Jaguar Social</h4>
...
const LREAD_KEY = 'ms_lecturas_v1';
    ...
    <div class="presentacion-preview">
      ...
      <button class="presentacion-preview__thumbnail" data-open-presentacion="${n}" aria-label="Abrir presentación de la ADA ${n} en pantalla completa">
        <span class="presentacion-preview__slide-mock">
          ...
          <span class="presentacion-preview__slide-subtitle">ADA ${n} — Medios Sociales</span>
        </span>
...
const JAG_TIPS = {
  home: '¡Bienvenido! Soy Jag, tu guía en medios sociales. Explora la ruta a tu ritmo.',
  ...
  complete: 'Lo lograste. De usuario a estratega. 🐆',
};
...
function checkReadingBadge(ada) {
  if (LecturaProgress.allRead(ada) && !LecturaProgress.badgeSeen(ada)) {
    ...
    const names = {1:'Explorador del Ecosistema',2:'Estratega de Contenido',3:'Creador Multimedia',4:'Ciudadano Digital Responsable',5:'Transformador Social'};
...
// Easter egg: Konami del estratega (m-s-2-0-2-6)
function setupKonami() {
  const seq = ['m','s','2','0','2','6']; let buf = [];
  document.addEventListener('keydown', (e) => {
    buf.push((e.key||'').toLowerCase()); buf = buf.slice(-6);
    if (buf.join('') === seq.join('')) { toast('🌙 Modo estratega nocturno: el mejor contenido se programa de madrugada.'); confetti(); }
  });
}
...
function consoleCochinita() {
  try {
    ...
    console.log('%cSi estás aquí, ya piensas como estratega de medios sociales. — @uady_oficial', 'color:#192E4C;');
  } catch {}
}
...
// ---- Brand assets injection (mantiene index.html liviano) ----
function injectBrandAssets() {
  const setSrc = (id, val) => { const el = document.getElementById(id); if (el && val) el.src = val; };
  // Logo UADY versión BLANCA en header (lección aprendida)
  setSrc('navbar-firma', ASSETS.firmaBlanco || ASSETS.firma);
  setSrc('footer-firma', ASSETS.firmaBlanco || ASSETS.firma);
  setSrc('jag-avatar-img', ASSETS.jaguar);
  const border = document.getElementById('footer-border');
  if (border) border.src = ASSETS.bordeDorado || ASSETS.bordeAzul || '';
  const pat = document.getElementById('footer-pattern');
  if (pat && ASSETS.patronDorado) pat.style.backgroundImage = `url('${ASSETS.patronDorado}')`;
  const fav = document.getElementById('favicon');
  if (fav && ASSETS.escudo) fav.href = ASSETS.escudo;
}
...
function setupGlobalEvents() {
  ...
  window.addEventListener('scroll', ()=>{ const nb=$('.navbar'); if(nb) nb.classList.toggle('navbar--scrolled', window.scrollY>10); }, { passive:true });
